  ...
  <div class="main" role="main">
    <div id="content" class="content page-content full">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h2><strong>Add Prescription</strong></h2>
            <hr/>
            <?php
            if($msg != '')
            {
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="medicine_name" name="medicine_name" class="form-control input-lg" placeholder="Medicine Name"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="quantity" name="quantity" class="form-control input-lg" placeholder="Medicine Quantity"/>
                        </div>
                    </div>
                </div>
                <div class="row">
          ...
          <div class="col-md-8">
            <h2>
                ...
                <a class="btn btn-primary btn-sm pull-right" href="history.php?patient_id=<?php echo $patient_id;?>">History</a>
            </h2>
            <hr/>
            <?php
            if($patient_id)
            {
                $helper->getPatientPrescriptions($patient_id);
            }
            ?>
          </div>
        </div>
